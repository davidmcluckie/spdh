...
int heater_min = 230; // Increase fuel if below
int heater_target = 240; // degrees C Decrease fuel if above, increase if below.
int water_warning = 270;// degrees C - At this temperature, the heater idles
int water_overheat = 320;// degrees C - This is the temperature the heater will shut down
...
float throttling_high_fuel = 2.8;
float throttling_high_fan = 68;
float throttling_steady_fuel = 2.5;
float throttling_steady_fan = 62;
float throttling_low_fuel = 2.3;  //(Winter Setting)
float throttling_low_fan = 50;
//Just enough to keep it alight at idle
float throttling_idle_fuel = 0.83; //Do not reduce this value
float throttling_idle_fan = 55; 
...
float start_fuel_Warm = 1.8;  //Winter Setting (use below 10C)
