...
int heater_min = 220; // Increase fuel if below
int heater_target = 250; // degrees C Decrease fuel if above, increase if below.
int water_warning = 270;// degrees C - At this temperature, the heater idles
int water_overheat = 300;// degrees C - This is the temperature the heater will shut down
...
float throttling_high_fuel = 2.5;
